...
using LockStockAuth.Auth;
using LockStockAuth.Auth.Entities;
using Microsoft.Owin.Security.Infrastructure;

namespace LockStockAuth.Providers
{
    public class SimpleRefreshTokenProvider : IAuthenticationTokenProvider
    {
        ...
        public async Task CreateAsync(AuthenticationTokenCreateContext context)
        {
            ...
            using (var repo = new AuthRepository())
            {
                ...
                {
                    Id = AuthDbContextConfiguration.GetHash(refreshTokenId),
                    ClientId = clientid,
        ...
        public async Task ReceiveAsync(AuthenticationTokenReceiveContext context)
        {
            ...
            var hashedTokenId = AuthDbContextConfiguration.GetHash(context.Token);
